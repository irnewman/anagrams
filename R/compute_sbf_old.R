...
# this should change to a different function name:
  # something that computes everything, but compute_sbf is for just sbf



compute_sbf_old <- function(word, word_length, number_of_bigrams, bigram_freq) {
